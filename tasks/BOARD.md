## In Progress
- <task as slug> (<task priority>) - owner: <task owner> - <link to session log>
- ...
...
## Done
- implement-health-check - [session](../sessions/2026-07-20-implement-health-check-for-backend-service.md)
