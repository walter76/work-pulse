    ...
    <Sheet sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
      ...
      <Sheet variant="outlined" sx={{ padding: 3 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: '20px' }}>
          <li><Typography level="body-sm">CW (integer)</Typography></li>
          <li><Typography level="body-sm">Date (format: DD.MM.)</Typography></li>
          <li><Typography level="body-sm">Check In (format: HH:MM)</Typography></li>
          <li><Typography level="body-sm">Check Out (format: HH:MM)</Typography></li>
          <li><Typography level="body-sm">Duration (format: HH:MM:SS)</Typography></li>
          <li><Typography level="body-sm">PAM Category (string)</Typography></li>
          <li><Typography level="body-sm">Topic (string)</Typography></li>
          <li><Typography level="body-sm">Comment (string)</Typography></li>
        </ul>
